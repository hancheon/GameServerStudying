...
namespace myLibrary
{
	...
	public:
		...
		// 생성자 / 소멸자
		MemoryPool(int initNodeNum, int poolID, bool isPlacementNew = false) : m_top(nullptr), m_isPlacementNew(isPlacementNew), m_capacityCnt(initNodeNum), m_usedCnt(0), m_poolID(poolID)
		{
			if (m_isPlacementNew)
			{
				// placement new 원할 때
